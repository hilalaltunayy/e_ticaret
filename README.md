...
This project is not just a working e-commerce system, but a security-focused, modular, and scalable architecture design built with long-term maintainability and system integrity in mind.
