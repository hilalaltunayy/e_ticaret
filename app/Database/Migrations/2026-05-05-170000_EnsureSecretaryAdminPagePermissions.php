...
class EnsureSecretaryAdminPagePermissions extends Migration
{
    public function up()
    {
        ...
        $permissions = [
            'manage_pages' => 'Sayfa yonetimi erisimi',
            'manage_banners' => 'Banner yonetimi erisimi',
            'manage_marketing' => 'Pazarlama sayfalari erisimi',
        ];
