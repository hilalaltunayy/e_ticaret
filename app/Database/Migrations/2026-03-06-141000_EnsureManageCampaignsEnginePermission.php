...
class EnsureManageCampaignsEnginePermission extends Migration
{
    public function up()
    {
        ...
        $perm = $this->db->table('permissions')
            ->select('id')
            ->where('code', 'manage_campaigns_engine')
            ->get()
            ->getRowArray();
        ...
        if ($permissionId === '') {
            ...
            $this->db->table('permissions')->insert([
                'id' => $permissionId,
                'code' => 'manage_campaigns_engine',
                'description' => 'Manage campaigns engine',
