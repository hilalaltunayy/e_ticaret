...
class ProductDetailPageBuilderService
{
    ...
    private function buildConfigPayload(array $input): array
    {
        ...
        return [
            ...
            'kisa_aciklama' => $this->sanitizeOptionalText($input['kisa_aciklama'] ?? $defaults['kisa_aciklama']),
            'bilgi_kampanya_rozeti_metni' => $this->sanitizeOptionalText($input['bilgi_kampanya_rozeti_metni'] ?? $defaults['bilgi_kampanya_rozeti_metni']),
            'urun_tanitim_baslik' => trim((string) ($input['urun_tanitim_baslik'] ?? $defaults['urun_tanitim_baslik'])),
            'urun_tanitim_kisa_aciklama' => $this->sanitizeOptionalText($input['urun_tanitim_kisa_aciklama'] ?? $defaults['urun_tanitim_kisa_aciklama']),
            ...
            'fiyat_satin_alma_aciklama' => $this->sanitizeOptionalText($input['fiyat_satin_alma_aciklama'] ?? $defaults['fiyat_satin_alma_aciklama']),
            ...
            'dijital_erisim_kisa_notu' => $this->sanitizeOptionalText($input['dijital_erisim_kisa_notu'] ?? $defaults['dijital_erisim_kisa_notu']),
            'teslimat_kargo_kisa_notu' => $this->sanitizeOptionalText($input['teslimat_kargo_kisa_notu'] ?? $defaults['teslimat_kargo_kisa_notu']),
            'guvenli_alisveris_kisa_notu' => $this->sanitizeOptionalText($input['guvenli_alisveris_kisa_notu'] ?? $defaults['guvenli_alisveris_kisa_notu']),
            ...
            'icerik_aciklama_notu' => $this->sanitizeOptionalText($input['icerik_aciklama_notu'] ?? $defaults['icerik_aciklama_notu']),
            'yorum_puan_baslik' => trim((string) ($input['yorum_puan_baslik'] ?? $defaults['yorum_puan_baslik'])),
            'yorum_ozeti_metni' => $this->sanitizeOptionalText($input['yorum_ozeti_metni'] ?? $defaults['yorum_ozeti_metni']),
            ...
            'yorum_yap_cagrisi_metni' => $this->sanitizeOptionalText($input['yorum_yap_cagrisi_metni'] ?? $defaults['yorum_yap_cagrisi_metni']),
            'ilgili_urunler_cta_baslik' => trim((string) ($input['ilgili_urunler_cta_baslik'] ?? $defaults['ilgili_urunler_cta_baslik'])),
            'ilgili_urunler_cta_aciklama' => $this->sanitizeOptionalText($input['ilgili_urunler_cta_aciklama'] ?? $defaults['ilgili_urunler_cta_aciklama']),
            ...
            'guven_notu_kisa_bilgi' => $this->sanitizeOptionalText($input['guven_notu_kisa_bilgi'] ?? $defaults['guven_notu_kisa_bilgi']),
        ];
    }
