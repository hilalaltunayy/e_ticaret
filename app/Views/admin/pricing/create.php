    ...
    <div class="row align-items-center">
      <div class="col-md-12">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item" aria-current="page">Yeni Fiyat Kuralı</li>
        </ul>
      </div>
      <div class="col-sm-6">
        <div class="page-header-title">
          <h2 class="mb-0"><?= esc($title ?? 'Yeni Fiyat Kuralı') ?></h2>
        </div>
      </div>
    </div>
  </div>
...
<div class="card">
  ...
  <div class="card-body">
    <form method="post" action="<?= site_url('admin/pricing/rules/store') ?>">
      <?= csrf_field() ?>
