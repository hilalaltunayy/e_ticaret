    ...
    <div class="row align-items-center">
      <div class="col-sm-6">
        <div class="page-header-title">
          <h2 class="mb-0"><?= esc($title ?? 'Kampanya / Fiyat Paneli') ?></h2>
        </div>
      </div>
  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body d-grid gap-2 d-md-flex">
        <button type="button" class="btn btn-outline-primary" disabled>Yeni Kampanya</button>
        <button type="button" class="btn btn-outline-secondary" disabled>Toplu İndirim</button>
        <button type="button" class="btn btn-outline-dark" disabled>Fiyat Güncelle (Excel)</button>
      </div>
    </div>
  </div>
